#define NGX_CONFIGURE " --prefix=/usr/local/nginx --user=nginx --group=nginx --with-http_ssl_module --with-http_gzip_static_module --http-client-body-temp-path=/usr/local/nginx/tmp/client/ --http-proxy-temp-path=/usr/local/nginx/tmp/proxy/ --http-fastcgi-temp-path=/usr/local/nginx/tmp/fcgi/ --with-poll_module --with-file-aio --with-http_realip_module --with-http_addition_module --with-http_random_index_module --with-pcre --with-http_stub_status_module --add-module=/backup/fastdfs/nginx-1.8.0/fastdfs-nginx-module/src"
...
#define NGX_HTTP_CLIENT_TEMP_PATH  "/usr/local/nginx/tmp/client/"
#endif
...
#define NGX_HTTP_FASTCGI_TEMP_PATH  "/usr/local/nginx/tmp/fcgi/"
#endif
